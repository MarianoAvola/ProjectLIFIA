...
public class DBliveryServiceTestCase {
    ...
    public void testGetUser() {
        ...
        Cliente u1 = this.service.createUser("hugo.gamarra@testmail.com", "123456", "hgamarra", "Hugo Gamarra", dob);
        assertNotNull(u1.getId());
        assertEquals("hgamarra", u1.getNombre());
        Optional<Cliente> u2 = this.service.getUserByUsername("hgamarra");
        if (u2.isPresent()) {
            Cliente u3 = u2.get();
            assertEquals("hgamarra", u3.getNombre());
            assertEquals("hugo.gamarra@testmail.com", u3.getEmail());
        }
        Optional<Cliente> u4 = this.service.getUserByEmail("hugo.gamarra@testmail.com");
        if (u4.isPresent()) {
            Cliente u5 = u4.get();
            assertEquals("hgamarra", u5.getNombre());
            assertEquals("hugo.gamarra@testmail.com", u5.getEmail());
        }
        Optional<Cliente> u6= this.service.getUserById(u1.getId());
        if (u6.isPresent()) {
            Cliente u7 = u6.get();
            assertEquals("hgamarra", u7.getNombre());
    ...
    public void testCreateOrder() throws DBliveryException {
        ...
        assertEquals(1,o2.getEstado());
        assertEquals(u1,o2.getCliente());
    ...
    public void testDeliverOrder() throws DBliveryException {
        ...
        Cliente u2 = this.service.createUser("delivery@info.unlp.edu.ar", "123456", "delivery", "Delivery", dob2);
        ...
        Pedido o3 = this.service.deliverOrder(o2.getId(),u2);
        assertNotNull(o3.getId());
        assertEquals(2,o3.getEstado());
        assertEquals(u2,o3.getRepartidor());
    }
    ...
    public void testGetProduct() {
        ...
        assertEquals("Burger King",s1.getNombre());
        Producto p1 = this.service.createProduct("Combo Stacker ATR", Float.valueOf(2521.2F), Float.valueOf(2.5F),s1);
        Producto p2 = this.service.createProduct("Combo Tostado de Campo", Float.valueOf(2210.2F), Float.valueOf(2.2F), s1);
        Producto p3 = this.service.createProduct("Combo Stacker ATR triple", Float.valueOf(1210F), Float.valueOf(1.8F), s1);
